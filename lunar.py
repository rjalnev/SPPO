...
class PPOAgent:
    def __init__(self, game, num_actions, epochs=10, episodes_per_batch=4, minibatch_size=32,
    ...
    #Build the actor and critic networks and define the custom loss function.
        ...
        A = Dense(512, activation='relu', kernel_initializer='he_uniform')(X_input)
        A = Dense(256, activation='relu', kernel_initializer='he_uniform')(A)
        ...
        #build critic
        C = Dense(512, activation='relu', kernel_initializer='he_uniform')(X_input)
        C = Dense(256, activation='relu', kernel_initializer='he_uniform')(C)
...
if __name__ == '__main__':
    ...
    ppo = PPOAgent('LunarLander-v2', 4, episodes_per_batch=12, alpha=1e-5, beta=1e-5, entropy_beta=0.01)
    ppo.actor.summary()
    ppo.critic.summary()
    
    #train model
    ppo.run(num_episodes=4000, checkpoint=True, cp_render=True, cp_interval=100)
    
    #load model
    ppo.load('models', 'PPO_100_LunarLander_Actor.h5', 'PPO_100_LunarLander_Critic.h5')
